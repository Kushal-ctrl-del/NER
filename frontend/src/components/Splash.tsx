...
export default function Splash() {
  ...
  return (
    <div className={`fixed inset-0 z-[9999] bg-white flex flex-col items-center justify-center transition-opacity duration-500 ease-in-out ${fade ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="absolute bottom-10 flex gap-2">
         ...
         <div className="w-16 h-1 bg-[#2a2a2a] rounded"></div>
